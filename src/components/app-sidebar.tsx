...
export function AppSidebar() {
  return (
    <Sidebar className="sticky top-0 hidden h-svh md:flex">
          ...
          <Sidebar.Group className="mb-1">
            <Sidebar.Menu>
              <Sidebar.MenuButton
                ...
                className="min-h-10 cursor-default bg-kumo-base text-lg font-medium text-kumo-strong shadow-xs ring ring-kumo-line disabled:opacity-100 group-data-[state=collapsed]/sidebar:size-8.5 group-data-[state=collapsed]/sidebar:min-h-8.5"
              >
      ...
      <Sidebar.Footer className="h-auto items-stretch px-3 py-3 group-data-[state=collapsed]/sidebar:hidden">
        <div className="w-full rounded-lg bg-kumo-base px-3 py-2.5 shadow-xs ring ring-kumo-line">
